...
- **유효한 정렬**
  ...
  - <img src="https://latex.codecogs.com/svg.image?\mathcal{A}^{\text{RNNT}}(X,&space;C)&space;=&space;\{&space;A&space;=&space;(a_1,&space;a_2,&space;\ldots,&space;a_{T&plus;L})&space;\}" alt="RNNT alignment" />
